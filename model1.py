...
class Model(nn.Module):
    def __init__(self, input_shape, n_actions):
        ...
        self.conv1 = nn.Conv2d(1, 4, kernel_size=(1, 1), stride=2, padding=0)
        self.bn1 = nn.BatchNorm2d(4)
        self.pool1 = nn.MaxPool2d(1, 1)
        self.conv2 = nn.Conv2d(4, 6, kernel_size=(1, 1), stride=2, padding=0)
...
class Actor(nn.Module):
    def __init__(self, n_actions):
        ...
        self.conv1 = nn.Conv2d(1, 4, kernel_size=(1, 3), stride=(1, 2), padding=0)
        self.bn1 = nn.BatchNorm2d(4)
        self.pool1 = nn.MaxPool2d(1, 1)
